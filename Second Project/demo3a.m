...
labels_12 = myNCuts(graph1, 2);
labels_13 = myNCuts(graph1, 3);
labels_14 = myNCuts(graph1, 4);
disp('Image d2a done.')

% label of d2b image for k = 2,3,4 
labels_22 = myNCuts(graph2, 2);
labels_23 = myNCuts(graph2, 3);
labels_24 = myNCuts(graph2, 4);
disp('Image d2b done.')
